/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 65f008529fc67e0d869fd4bd9a9cbb8b)
// Runtime types generated with workerd@1.20250604.0 2025-06-14 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LINE_CHANNEL_SECRET: string;
		LINE_CHANNEL_ACCESS_TOKEN: string;
		ALLOWED_TALK_ROOMS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINE_CHANNEL_SECRET" | "LINE_CHANNEL_ACCESS_TOKEN" | "ALLOWED_TALK_ROOMS">> {}
}
